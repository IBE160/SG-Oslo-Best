The focus is on building a minimum viable product (MVP) that proves the core concept: generating personalized, high-quality cover letters from a student’s CV and job details.

The project is following BMAD-methodology (4-phase model)

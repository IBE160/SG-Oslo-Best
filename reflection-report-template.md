...
Uten KI ville planleggingen gått saktere, fordi vi måtte da har gjort mer arbeid på forhånd før vi kunne i det hele tatt kunne begynne å utvikle. Applikasjonen ville sannsynligvis blitt enklere og mer begrenset i funksjonalitet, ettersom vi måtte ha forstått hver enkelt del av teknologien før vi kunne anvende den. Dette innebærer alt fra database oppsett til frontend-struktur og backend-logikk. Uten KI som støtte ville vi som gruppe kjent mye sterkere tidspress. Prosjektet foregikk gjennom en periode av 6 uker, og med vår erfaring ville det ha vært utfordrende å få på plass en funksjonell løsning uten å bli mer stresset i prosessen.
...
Dette prosjektet snudde opp ned på hvordan jeg ser på KI i utvikling. Jeg gikk inn med en idé om at KI skulle gjøre livet enklere. I stedet skjønte jeg at KI gjør at jeg må være enda mer skjerpet, enda mer strukturert og enda mer teknisk opplyst.
Jeg har fått respekt for alt som skjer under panseret, fra PATH variabler til hvordan servere kommuniserer, hvordan imports fungerer og hvordan hele systemet henger sammen. Det er ting KI ikke kan redde deg fra.
Sånn jeg ser det nå:
KI er et rått verktøy, men det er fortsatt jeg som må styre. Hvis jeg ikke gjør det, smeller det.
Jeg sitter igjen mer robust, mer kritisk og mye mer klar over at verktøy ikke er erstatning for kompetanse. Det er fortsatt mitt ansvar å sørge for struktur, flyt og kvalitet. KI er bare hjelp. Det tar aldri over jobben min.
...
**Jenny Løvik Brøyn:**
Personlig synes jeg den mest verdifulle læringen ved utviklingen av applikasjonen var gjennom det tette og kontinuerlige samarbeidet med gruppen, der vi sammen jobbet systematisk gjennom fase 1, 2, 3 og 4. BMAD-rammeverket ga god støtte i struktureringen av arbeidet og bidro til å utvikle ferdigheter innen "vibe coding". For egen del var den jevnlige deltakelsen i gruppemøtene avgjørende for å få fullt utbytte av prosessen, siden det gjorde det mulig å følge alle fasene og dermed få en bedre forståelse av sammenhengen mellom dem.
